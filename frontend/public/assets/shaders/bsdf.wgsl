...
// 	out.positionSS = uniforms.mvp * vec4f(in.positionOS, 1.0);
// 	out.positionWS = (uniforms.model * vec4f(in.positionOS, 1.0)).xyz;
// 	out.normalWS = (uniforms.model * vec4f(in.normalOS, 0.0)).xyz;
// 	return out;
// }
